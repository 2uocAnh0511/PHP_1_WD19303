...
?>
        <style>
            body {
                ...
                /* Thay đổi kích thước của hình ảnh để nó đầy đủ chiều rộng của cửa sổ trình duyệt */
            }
            ...
            .login-form {
                ...
                width: 400px;
                /* Đặt chiều rộng mong muốn cho form */
                max-width: 80%;
            ...
            .login-form input[type="submit"]:hover {
                ...
                /* Màu xanh nước đậm hơn khi hover */
            }
        ...
        <div class="login-form">
            <form method="POST" action="?act=HandleRegister" >
                <div class="card-header">Register</div>
                <label for="register_email">Email</label><br>
                <input type="text" id="register_email" name="email" required><br><br>
                ...
                <input type="text" id="register_name" name="name" required><br><br>

                <label for="register_avatar">Avatar</label><br>
                <input type="file" id="register_avatar" name="avatar" required><br><br>
